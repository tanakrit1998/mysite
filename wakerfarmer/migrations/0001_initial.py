# Generated by Django 2.2.7 on 2020-02-11 08:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('map', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='wakerfarmer.Map')),
                ('price', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='wakerfarmer.Price')),
                ('queue', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='wakerfarmer.Queue')),
            ],
        ),
    ]
